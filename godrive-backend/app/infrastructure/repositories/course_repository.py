...
from app.infrastructure.db.models.course import Course, Module, Lesson, Enrollment
...
class CourseRepository:
    ...
    def create(self, db: Session, course: CreateCourseDTO):
        db_obj = Course(
            title=course.title,
    ...
    def create_module(self, db: Session, course_id: int, module: CreateModuleDTO):
        db_module = Module(
            course_id=course_id,
            title=module.title,
            order=module.order
    ...
    def create_lesson(self, db: Session, module_id: int, lesson: CreateLessonDTO):
        db_lesson = Lesson(
            module_id=module_id,
            title=lesson.title,
