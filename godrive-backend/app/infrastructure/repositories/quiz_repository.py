...
from app.infrastructure.db.models.quiz import Quiz, Question, QuestionOption, UserQuizAttempt
from app.application.dtos import CreateQuizDTO, CreateQuestionDTO

class QuizRepository:
    
    def create_quiz(self, db: Session, quiz_in: CreateQuizDTO):
        db_quiz = Quiz(
    ...
    def add_question(self, db: Session, quiz_id: int, question_in: CreateQuestionDTO):
        # 1. Cria a pergunta
